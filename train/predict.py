...
def main(params):
    ...
    # save_dir = save_dir+"/bridge2algebra2006_simpleKeenKT_qid_saved_model_42_0_0.1_512_64_2_4_0.5_0.5_0.5_50_256_64_4_4_1e-05_0_0_1_0.02_1_0"
    with open(os.path.join(save_dir, "config.json")) as fin:
        ...
        if model_name in ["saint", "sakt", "atdkt", "KeenKT", "KEENKT"]:
